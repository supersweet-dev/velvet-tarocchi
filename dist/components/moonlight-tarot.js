...
const root = React.ReactDOM.createRoot(document.getElementById('root')); //Cards DB
...
const TarotBoard = props => {
  return /*#__PURE__*/React.createElement(_Box.default, null, /*#__PURE__*/React.createElement(_material.Card, {
    onClick: flip(props.flipped)
...
const flip = flipped => {
  if (flipped) {
    root.render( /*#__PURE__*/React.createElement(TarotBoard, {
      img: cards[0].image,
      flipped: !flipped
    }));
  } else {
